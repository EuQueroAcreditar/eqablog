...
Recentemente instalei uma [extensão para Firefox que bloqueia canais no YouTube](https://addons.mozilla.org/en-US/firefox/addon/video-blocker/). Sem demora comecei a bloquear todos canais de [FNORD](https://pt.wikipedia.org/wiki/FNORD) e [contos-da-carochinha](http://www.dicionarioinformal.com.br/conto-da-carochinha/) que vinham pela frente.
